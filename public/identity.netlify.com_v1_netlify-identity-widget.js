!(function (e) {
  ...
  function (e, n, t) {
    ...
    function a(e, n) {
      ...
      for (
        n && null != n.children && (i.length || i.push(n.children), delete n.children);
        i.length;
    ...
    function A(e, n, t, r, o) {
      if (("className" === n && (n = "class"), "key" === n));
        ...
        if ("style" === n) {
          if (
            ((r && "string" != typeof r && "string" != typeof t) || (e.style.cssText = r || ""),
            r && "object" == typeof r)
          ) {
          ...
          null == r || !1 === r
            ...
            : "function" != typeof r &&
              (a
                ? e.setAttributeNS("http://www.w3.org/1999/xlink", n.toLowerCase(), r)
                : e.setAttribute(n, r));
        }
      else e.className = r || "";
    }
              ...
              if (0 !== y)
                for (var A = 0; A < y; A++) {
                  ...
                  null != (E = T && p ? (d._component ? d._component.__key : p.key) : null)
                    ? (D++, (N[E] = d))
                    : (p || (void 0 !== d.splitText ? !o || d.nodeValue.trim() : o)) &&
                      (l[z++] = d);
                }
              if (0 !== T)
                for (A = 0; A < T; A++) {
      ...
      if (!e._disable) {
        ...
        if (
          (e.constructor.getDerivedStateFromProps &&
            ((c = u(u({}, c), e.constructor.getDerivedStateFromProps(s, c))), (e.state = c)),
          y &&
            ((e.props = N),
            (e.state = D),
            (e.context = g),
          ...
          if ("function" == typeof L) {
            ...
            (a = z),
              ...
              (z || 1 === n) &&
                (a && (a._component = null), (I = x(a, i, l, t || !y, z && z.parentNode, !0)));
          if (z && I !== z && M !== f) {
            var m = z.parentNode;
                    ...
                    (e.lowestObserverState = K.STALE),
                      e.observers.forEach(function (n) {
                        n.dependenciesState === K.UP_TO_DATE &&
                          (n.isTracing !== $.NONE && We(n, e), n.onBecomeStale()),
...
***************************************************************************** */ var x =
        ...
        var xe = (function (e) {
            ...
            return (
              ...
              (n.prototype.setNewValue = function (e) {
                ...
                (this.value = e),
                  this.reportChanged(),
                  ut(this) && ct(this, { type: "update", object: this, newValue: e, oldValue: n });
              }),
              ...
              (n.prototype.observe = function (e, n) {
                return (
                  n && e({ object: this, type: "update", newValue: this.value, oldValue: void 0 }),
                  st(this, e)
                );
              }),
          ...
          he = (function () {
            function e(e) {
              (this.dependenciesState = K.NOT_TRACKING),
                ...
                (this.equals =
                  e.equals || (e.compareStructural || e.struct ? I.structural : I.default)),
            ...
            return (
              ...
              (e.prototype.get = function () {
                this.isComputing &&
                  M("Cycle detected in computation " + this.name + ": " + this.derivation),
          ...
          if (0 == --Ye.inBatch) {
            ...
            for (var e = Ye.pendingUnobservations, n = 0; n < e.length; n++) {
              ...
              (t.isPendingUnobservation = !1),
                0 === t.observers.size &&
                  (t.isBeingObserved && ((t.isBeingObserved = !1), t.onBecomeUnobserved()),
        ...
        function We(e, n) {
          if (
            (console.log(
              "[mobx.trace] '" + e.name + "' is invalidated due to a change in: '" + n.name + "'",
            ),
            e.isTracing === $.BREAK)
          ) {
            var t = [];
        ...
        var Ve = (function () {
          ...
          return (
            ...
            (e.prototype.dispose = function () {
              this.isDisposed ||
                ((this.isDisposed = !0), this._isRunning || (Ze(), se(this), Ge()));
            }),
        ...
        function tn(e) {
          return function (n, t, r) {
            if (r) {
              if (r.value)
                return { value: fe(e, r.value), enumerable: !1, configurable: !0, writable: !0 };
              var o = r.initializer;
              return {
                enumerable: !1,
                configurable: !0,
        ...
        function Jn(e, n) {
          ...
          return (
            ...
            n || (n = Wn),
            (n.detectCycles =
              void 0 === n.detectCycles ? !0 === n.recurseEverything : !0 === n.detectCycles),
            ...
            (function e(n, t, r) {
              ...
              if ((Un(n) && Qn(n), !0 === t.detectCycles && null !== n && r.has(n)))
                return r.get(n);
        ...
        var Dt = (function () {
            ...
            return (
              ...
              (e.prototype.spliceWithArray = function (e, n, t) {
                ...
                return (
                  (0 === n && 0 === t.length) || this.notifyArraySplice(e, t, a),
              ...
              (e.prototype.spliceItemsIntoValues = function (e, n, t) {
                ...
                return (
                  (this.values = this.values.slice(0, e).concat(t, this.values.slice(e + n))), o
                );
              }),
              (e.prototype.notifyArrayChildUpdate = function (e, n, t) {
                var r = !this.owned && !1,
                  ...
                  i =
                    o || r
                      ? { object: this.proxy, type: "update", index: e, newValue: n, oldValue: t }
                      : null;
        ...
        var Tt,
            ...
            return (
              ...
              (e.prototype._updateValue = function (e, n) {
                ...
                if ((n = t.prepareNewValue(n)) !== Ye.UNCHANGED) {
                  var r = ut(this),
                    o = r
                      ? { type: "update", object: this, oldValue: t.value, name: e, newValue: n }
                      : null;
                  ...
                  Xn(function () {
                    ...
                    if (!s)
                      if (n._data.size !== u.size) n._keysAtom.reportChanged();
                        ...
                        for (
                          var d = n._data.keys(), p = u.keys(), E = d.next(), w = p.next();
                          !E.done;
          ...
          Et = (function () {
            ...
            return (
              ...
              (e.prototype.delete = function (e) {
                var n = this;
                if (it(this) && !(r = at(this, { type: "delete", object: this, oldValue: e })))
                  return !1;
                if (this.has(e)) {
                  var t = ut(this),
              ...
              (e.prototype.entries = function () {
                ...
                return _t({
                  next: function () {
                    var r = e;
                    return (
                      (e += 1), r < t.length ? { value: [n[r], t[r]], done: !1 } : { done: !0 }
                    );
                  },
                });
              }),
            ...
            return (
              ...
              (e.prototype.remove = function (e) {
                if (this.values.has(e)) {
                  var n = this.target;
                  if (it(this))
                    if (!(M = at(this, { object: this.proxy || n, name: e, type: "remove" })))
                      return;
                  try {
                    Ze();
                    var t = ut(this),
                    ...
                    var M = t
                      ? { type: "remove", object: this.proxy || n, oldValue: o, name: e }
                      : null;
                    0, t && ct(this, M);
                  } finally {
                    Ge();
              ...
              (e.prototype.notifyPropertyAddition = function (e, n) {
                var t = ut(this),
                  r = t
                    ? { type: "add", object: this.proxy || this.target, name: e, newValue: n }
                    : null;
      ...
      return (
        ...
        (n.i = function (e, t, r) {
          ...
          for (var a = 0; a < e.length; a++) {
            var u = [].concat(e[a]);
            (r && o[u[0]]) ||
              (t && (u[2] ? (u[2] = "".concat(t, " and ").concat(u[2])) : (u[2] = t)), n.push(u));
          }
        }),
        n
      );
  ...
  function (e, n, t) {
      ...
      return (
        ...
        (function (e, n) {
          ...
          try {
            for (
              t = t.call(e);
              !(M = (r = t.next()).done) && (i.push(r.value), !n || i.length !== n);
              M = !0
            );
          } catch (e) {
            (a = !0), (o = e);
    ...
    var f = { login: !0, signup: !0, error: !0 },
      A = {
        ...
        refresh: function (e) {
          return (
            u.default.gotrue || u.default.openModal("login"), u.default.gotrue.currentUser().jwt(e)
          );
        },
        init: function (e) {
          !(function () {
            ...
            Array.prototype.slice.call(N).forEach(function (e) {
              ...
              (w.onload = function () {
                ...
                (e.innerHTML = c.default.toString()),
                  ...
                  (E = (0, r.render)(
                    (0, r.h)(i.Provider, { store: u.default }, (0, r.h)(a.default, null)),
              ...
              value: function (e, n, t) {
                ...
                return (
                  ...
                  this._request("/verify", {
                    method: "POST",
                    body: JSON.stringify({ token: e, password: n, type: "signup" }),
                  }).then(function (e) {
        ...
        return (function (e, n) {
          ...
          try {
            for (
              ...
              !(r = (M = a.next()).done) && (t.push(M.value), !n || t.length !== n);
              r = !0
            );
          } catch (e) {
            (o = !0), (i = e);
                ...
                if (t)
                  try {
                    var r = JSON.parse(t),
                      ...
                      a = r.audience;
                    return o && M
                      ? new e(n || new i.default(o, {}), M, a)._saveUserData(r, !0)
                      : null;
                  } catch (e) {
                    return (
                      console.error(new Error("Gotrue-js: Error recovering session: ".concat(e))),
                      null
                    );
                  }
                return null;
          ...
          (t = [
            {
              ...
              value: function (e) {
                var n = this;
                return this._request("/user", { method: "PUT", body: JSON.stringify(e) }).then(
                  function (e) {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                try {
                  ...
                  console.error(
                    new Error("Gotrue-js: Failed to parse tokenResponse claims: ".concat(e)),
                  );
                }
              },
            },
            ...
            },
            {
              ...
              value: function () {
                return (
                  j() && localStorage.setItem("gotrue.user", JSON.stringify(this._details)), this
                );
              },
            },
            {
          ...
          },
          {
            ...
            value: function (e, n) {
              ...
              return (
                (t.email = e),
                (t.password = n),
                this.user._request("/admin/users", { method: "POST", body: JSON.stringify(t) })
              );
            },
          },
          {
              ...
              (t = [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var n = ["Google", "GitHub", "GitLab", "BitBucket", "SAML"].filter(
                      function (n) {
                  ...
                  (0, o.h)(
                    ...
                    n.title &&
                      (0, o.h)(
                        "div",
                        { className: "header" },
                        (0, o.h)("button", { className: "btn btnHeader active" }, l(n.title)),
                      ),
                    a &&
                      (0, o.h)(
                        "div",
  ...
  function (e, n, t) {
    ...
    (i.setNamePlaceholder = (0, r.action)(function (e) {
      ...
      (i.init = (0, r.action)(function (e, n) {
        e && ((i.gotrue = e), (i.user = e.currentUser()), i.user && (i.modal.page = "user")),
          n && i.loadSettings();
      })),
